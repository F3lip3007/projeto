        ...
        <h3>Gênero:<br>
            ...
            <h3>Título:<br>
                ...
                <div class="radio-group">
                    <?php
                    if ($disponivel == 0) {
                        echo "<label><input type='radio' name='disponivel' value='1'>Sim</label>";
                        echo "<label><input type='radio' name='disponivel' value='0' checked>Não</label>";
                    } else if ($disponivel == 1) {
                        echo "<label><input type='radio' name='disponivel' value='1' checked>Sim</label>";
                        echo "<label><input type='radio' name='disponivel' value='0'>Não</label>";
                    } else {
                        echo "<label><input type='radio' name='disponivel' value='1'>Sim</label>";
                        echo "<label><input type='radio' name='disponivel' value='0'>Não</label>";
                    }
